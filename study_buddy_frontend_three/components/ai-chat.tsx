...
export function AIChat() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      role: "ai",
      content: "Hey! I'm your Padhle Bhai 🫵 AI. Ask me anything about your study material!",
    },
  ])
  ...
  const handleSend = async () => {
    ...
    try {
      const currentChildId = typeof window !== "undefined" ? localStorage.getItem("child_id") || "1" : "1"
      ...
      const res = await fetch("http://localhost:8001/ai/chat", {
        ...
        body: JSON.stringify({
          ...
          child_id: parseInt(currentChildId, 10)
        }),
      })
  ...
  return (
    <div className="glass rounded-2xl flex flex-col h-80">
      <div className="px-4 py-3 border-b border-chalk-white/10 flex items-center gap-2">
        ...
        <span className="text-sm font-semibold text-chalk-white">Padhle Bhai 🫵 AI</span>
      </div>
